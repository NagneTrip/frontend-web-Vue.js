<template>
    <li class="notice-item">
        <div class="noticer-img">
            <img :src="notice.fromUserProfileImage || '/assets/logo/logo_img.png'"
                onerror="this.src='/assets/logo/sad_logo.png'" alt="" :width="50" :height="50"
                @click="moveTo('user')" />
        </div>
            ...
            <div class="noticer-info">
                <div class="noticer">
                    <div class="name-tier" @click="moveTo('user')">
                        ...
                        <img :src="`/assets/tier/${notice.fromUserTier}.svg`"
                            onerror="this.src='/assets/logo/sad_logo.png'" alt="" :width="14" :height="16">
                    </div>
