    ...
    <li class="notice-item">
        ...
        <div class="notice-info">
            ...
            <div class="notice-content">
                <p v-if="notice.type=='LIKE'" class="notice-type jua-regular">회원님의 게시글에 좋아요를 눌렀어요.</p>
                <p v-if="notice.type=='COMMENT'" class="notice-type jua-regular">회원님의 게시글에 댓글을 달았어요.</p>
                <p v-if="notice.type=='BOOKMARK'" class="notice-type jua-regular">회원님의 게시글을 저장했어요.</p>
            </div>
        </div>
