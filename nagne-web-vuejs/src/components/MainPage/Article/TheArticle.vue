          ...
          <div class="social-box">
            <div class="social-left-box">
              <div class="social-like">
                <svg v-show="!isLiked || !store.isAuthenticated" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="social-btn"
            ...
            <div class="social-right-box">
              <div class="social-bookmark">
                <svg v-show="isBookmarked && store.isAuthenticated" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="social-btn"
