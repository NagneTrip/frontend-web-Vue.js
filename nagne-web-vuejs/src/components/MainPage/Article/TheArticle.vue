          ...
          <div class="social-box">
            <div class="social-left-box">
              <div class="social-like">
                <svg v-show="!isLiked || !authStore.isAuthenticated" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="social-right-box">
              <div class="social-bookmark">
                <svg v-show="isBookmarked && authStore.isAuthenticated" xmlns="http://www.w3.org/2000/svg"
